...
CREATE TABLE Ragas (
	...
	CONSTRAINT FK_Ragas_CategoryID_Subcategories FOREIGN KEY (CategoryID) REFERENCES Categories(ID),
...
CREATE TABLE MusicPieces (
	...
	ModifiedDate INT NULL,
	LanguageID INT DEFAULT(1),
	CONSTRAINT FK_MusicPieces_SubcategoryID_Subcategories FOREIGN KEY (CategoryID) REFERENCES Categories(ID),
